        ...
        <section class="page-section clearfix">
            <div class="container">
                <div class="intro">
                    ...
                    <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" style="height: 400px;width: 300px;" src="{{Auth::user()->pro_pic}}" alt="">
                    @else
                    <img class="intro-img img-fluid mb-3 mb-lg-0 rounded" style="height: 400px;width: 300px;" src="img/intro.jpg" alt="">
                    @endif
                    ...
                    <div class="col-xl-9 mx-auto">
                        <div class="cta-inner text-center rounded">
                            ...
                            <p class="mb-0"> The yearbook is an opus of memories that you would carry along graduating from the institute. The wonderful years spent in the campus are engraved and expressed via photographs and writeups in this departing souvenir from IIT KGP. 
                                With an assortment of your thoughts and snaps from various experiences through the years, the book truly collaborates your time in KGP and is a walk down your memory lane every time you look through it.
                            </p>
                            <br>
                            <h2 class="section-heading mb-4">
                                <span class="section-heading-upper"></span>
