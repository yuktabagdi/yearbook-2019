                        ...
                        <div class="col-lg-12">
                            <div class="box" style="border-radius: 3px;font-color:#88898a">
                                <form id="upload-image-form" action="/upload1" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="classifiers" style="margin-left:40%;margin-top:1%" >
                                            <h5 style="color:#88898a"><b>Select Category: (Max size: 5MB)</b></h5>
                                        </label>
                                    ...
                                    <div class="form-group">
                                        <label for="caption" style="margin-left:48%">
                                            <h5 style="color:#88898a"><b>Caption:</b></h5>
                                        </label>
